...
!     ---------- ---- 
      ...
      DOUBLE PRECISION, PARAMETER ::   ALPHA1=1.673915E-2*1E3
      DOUBLE PRECISION, PARAMETER ::   ALPHA2=9.523810E-3*1E3
      DOUBLE PRECISION, PARAMETER ::   ALPHA3=1.E-4*1E3
      DOUBLE PRECISION, PARAMETER ::   BETA1=5.118377E-1*1E3
      DOUBLE PRECISION, PARAMETER ::   BETA2=6.258680E-3*1E3
      DOUBLE PRECISION, PARAMETER ::   BETA3=2.639456E-5*1E3
      DOUBLE PRECISION, PARAMETER ::   BETA4=3.628118E-8*1E3
      DOUBLE PRECISION, PARAMETER ::   BETA5=5.833333E-3*1E3
      DOUBLE PRECISION, PARAMETER ::   GAMMA1=1.851250E-3*1E3
      DOUBLE PRECISION, PARAMETER ::   GAMMA2=1.125000E-5*1E3
      DOUBLE PRECISION, PARAMETER ::   GAMMA3=2.5E-4*1E3
