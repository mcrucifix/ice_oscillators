...
outputdata=sprintf('Cardinality_beta_gamma.RData',na)
outputpng =sprintf('Cardinality_beta_gamma.png',na)
...
main='Periodic forcing (41,000 years)', frame.plot=TRUE, axes=FALSE) #, xlim=c(0.9,1.3))
#mtext('40-k forcing  ', 3, line=0)
axis(2)
