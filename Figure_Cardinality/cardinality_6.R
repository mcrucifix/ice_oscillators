...
outputdata=sprintf('Cardinality_6.RData',na)
outputpng =sprintf('Cardinality_6.png',na)
...
breaks=(0:6)
image(KList, breaks=breaks, col=Col, xlab=expression(omega[epsilon*1]/omega[N]), ylab=expression(gamma), 
main='Cardinality of pullback attractor : astro forcing', frame.plot=TRUE, axes=FALSE)
axis(2)
...
axis(1, at=(1:5)*p1, lab=(1:5), col='blue', col.tick='blue',
        ...
        col.lab='blue', tcl=-0.2, mgp=mgps) 
mtext(expression(omega[p*1]/omega[N]), line=3, col='blue',1, at=1)


axis(1, at=(2:5)*p2, lab=(2:5), col='red', col.tick='red',
        col.axis='red',cex.lab=0.6, cex.axis=0.6,
        col.lab='blue', tcl=-0.2,   mgp=mgps)
mtext(expression(omega[p*2]/omega[N]), line=3, col='red', 1, at=2.5)

axis(1, at=(2:4)*p3, lab=(2:4), 
          col='purple', col.tick='purple',col.axis='purple',
          cex.lab=0.6, cex.axis=0.6, col.lab='blue', tcl=-0.2,mgp=mgps)

mtext(expression(omega[p*3]/omega[N]), line=3, col='purple', 1, at=3.0)
